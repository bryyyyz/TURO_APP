    ...
    <div class="visual-section desktop-only">
      ...
      <div class="geometric-wrapper">
        ...
        <div class="diamond-frame">
          <img src="/images/tutor.png" alt="Tutor" class="feature-image" />
        </div>
      </div>

      <div class="tagline-container">
        <h1>Share Knowledge.<br />Shape the Future.</h1>
        <p>Empowering educators. Together.</p>
    ...
    <div class="form-section">
      ...
      <div class="login-card animate-scale-in">
        <div class="card-header">
          <span class="portal-badge">Tutor Portal</span>
          <h2>Welcome back!</h2>
          <p>Sign in to manage your teaching journey.</p>
        </div>
        ...
        <p class="switch-link">
          Are you a student? <router-link to="/login/student">Login here</router-link>
        </p>

        <!-- Mobile Signup Redirect -->
        <div class="mobile-only mobile-footer">
          <p>New to TURO? <router-link to="/signup">Apply to teach</router-link></p>
        </div>
      </div>
    </div>
  </div>
...
const features = [
  { title: 'High Earnings', sub: 'Set your own rates', svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>' },
  { title: 'Flexible Hours', sub: 'Teach when you want', svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>' },
  { title: 'Broad Reach', sub: 'Connect nationwide', svg: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>' }
];
...
.shape-blue { width: 300px; height: 300px; background: #1e3a8a; z-index: 1; left: 5%; }
.shape-light { width: 280px; height: 280px; background: #dbeafe; z-index: 0; left: 20%; top: -15%; }
.dots-pattern { position: absolute; width: 100px; height: 100px; background-image: radial-gradient(#94a3b8 2px, transparent 2px); background-size: 12px 12px; z-index: 0; }
...
.tagline-container h1 { font-family: var(--font-display); font-size: 2.2rem; font-weight: 800; color: #1e3a8a; line-height: 1.1; margin-bottom: 0.5rem; }
...
.icon-wrap { width: 34px; height: 34px; background-color: #eff6ff; border-radius: 10px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; color: #1e3a8a; }
.icon-wrap svg { width: 18px; height: 18px; }
.feature .text strong { display: block; font-size: 0.8rem; font-weight: 800; color: #1e3a8a; }
...
.btn-signup { padding: 0.5rem 1.2rem; border: 1.5px solid #e2e8f0; border-radius: 0.75rem; color: #1e3a8a; text-decoration: none; font-weight: 700; font-size: 0.8rem; background: #ffffff; }
...
.portal-badge { display: inline-block; padding: 0.2rem 0.6rem; background: #eff6ff; color: #1e3a8a; border-radius: 2rem; font-size: 0.6rem; font-weight: 800; text-transform: uppercase; margin-bottom: 0.5rem; }
.card-header h2 { font-family: var(--font-display); font-size: 2rem; font-weight: 800; color: #1e3a8a; margin-bottom: 0.4rem; }
...
.input-group label { display: block; font-size: 0.85rem; font-weight: 800; color: #1e3a8a; margin-bottom: 0.4rem; }
...
.input-field input:focus { border-color: #1e3a8a; background: #ffffff; box-shadow: 0 0 0 4px rgba(30, 58, 138, 0.05); }
...
.btn-submit {
  width: 100%;
  background: linear-gradient(135deg, #1e3a8a 0%, #2d52a0 100%);
  color: #ffffff;
  border: none;
  padding: 0.9rem;
...
.btn-submit:hover:not(:disabled) {
  background: linear-gradient(135deg, #25467e 0%, #3360b8 100%);
...
@media (max-width: 768px) {
  ...
  .card-header h2 { font-size: 24px; color: #1e3a8a; }
  .card-header p { font-size: 14px; margin-bottom: 2rem; }
  .portal-badge { font-size: 10px; margin-bottom: 8px; }
  .form-body { gap: 1rem; }
  ...
  .mobile-footer a { color: #1e3a8a; font-weight: 800; text-decoration: none; }
}
</style>
